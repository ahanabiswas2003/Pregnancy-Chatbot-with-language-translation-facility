...
function addGreetingMessage() {
    ...
    greetingElement.textContent = 'Hello! I’m here to support you during your pregnancy. How can I help you today?';
...
languageSelect.addEventListener('change', function() {
    ...
    addChatMessage('Bot', `Language changed to ${selectedLanguage}. Future responses will be in this language.`);
});